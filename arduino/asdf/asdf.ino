...
#define SSID        "Funny, It worked last time"
#define PASSWORD    "poppie2asterix"
...
void setup(void)
{
    ...
    if (wifi.setTCPServerTimeout(100000)) { 
        SerialUSB.print("set tcp server timout 100000 seconds\r\n");
    } else {
...
void loop(void)
{
    ...
    if (len > 0) {
        ...
        SerialUSB.print(wifi.getStatus());
        SerialUSB.println("]");
